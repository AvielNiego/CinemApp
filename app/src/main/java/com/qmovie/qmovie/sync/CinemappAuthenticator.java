...
/**
 * Manages "Authentication" to CinemApp's backend service.  The SyncAdapter framework
 ...
 */
public class CinemappAuthenticator extends AbstractAccountAuthenticator {

    public CinemappAuthenticator(Context context) {
        super(context);
    }
